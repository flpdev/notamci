...
<html>
<head>
    <title>NotamCI - Repositório de respostas desafio nota máxima</title>
    <meta charset="utf-8" />
...
<div class="container">
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url('home/pesquisar'); ?>">
        ...
        <div class="form-group" id="banner">
            ...
            <a href="http://www.SmarterASP.NET/index?r=flpz0r">
                <img src="http://www.SmarterASP.NET/affiliate/728X90.gif" border="0">
            </a>
            </div>
        </div>
    </form>
    ...
    <div class='panel panel-default' id="painelresposta">
