...
class Home extends CI_Controller{
    ...
    public function pesquisar(){
        ...
        if($lista!=null){
            ...
            $dadospg['erro'] = "<p class='bg-danger bs-p text-center'>Nenhum resultado para pesquisa realizada. Após responder seu questionário cadastre as respostas para que outros possam pesquizar.</p>";
        }
